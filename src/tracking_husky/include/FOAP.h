...
struct TTF{
    ...
    void init_ht(const int n_robots, const int dim, Eigen::VectorXd const params);
};
...
class FOAP{
    public:
        ...
        static Eigen::MatrixXd displacementVector(double theta, double rz, int n, int dim = 2);
        static Eigen::MatrixXd displacementVector2(double theta, double rz, int n, int dim = 2);
	...
	static Eigen::VectorXd alfa_vel(Eigen::MatrixXd const E, Eigen::MatrixXd const vel);
	...
	static Eigen::VectorXd gains(Eigen::VectorXd e_i,double k1, double k2,int n_robots);        
	...
	static Eigen::VectorXd conPredefined(double h,double hp, double x_b, double kf, Eigen::VectorXd e_0, Eigen::VectorXd e_i);
        ...
        static Eigen::VectorXd obstacleAvoidance(Eigen::MatrixXd const q, Eigen::MatrixXd const q_ev, Eigen::VectorXd const ratios,
                                Eigen::VectorXd const p_ia, Eigen::MatrixXd const J_2, TTF &ht,
                                double t, double d, double dt, int i_agent,float nearestDist);
	static Eigen::VectorXd convexCombination_noht(Eigen::MatrixXd const q, Eigen::MatrixXd const qobs, Eigen::VectorXd const ratios,
                                Eigen::VectorXd const p_ia, Eigen::MatrixXd const J_2, TTF &ht,
                                double t, double d, double dt, int i_agent);
        static Eigen::VectorXd getSingleAgent(Eigen::VectorXd const e_q, int n_agents, int current);
	static Eigen::VectorXd TTFgain_consensus(double tf,double t,double kf);
...
//static void initTBG(TBG &tbg, Eigen::VectorXd const params);
        ...
        static Eigen::MatrixXd vector2matrix(Eigen::VectorXd v, int dim = 2);
...
static Eigen::VectorXd TTFgain(double d, double t0, double tf, double a0, double t);
//static Eigen::VectorXd TBGgain_consensus(double tf,double t,double kf);
        static void xi(TTF &ht, double eo, double t, double d, double dt, int i_agent);
};
} // namespace Foap
